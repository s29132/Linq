...
namespace LinqTutorials
{
    public static class LinqTasks
    {
        ...
        {
            IEnumerable<Emp> result = Emps.Where(e => e.Job == "Backend programmer" && e.Salary > 1000).OrderBy(e => e.Ename);
            return result;
        }
        ...
        {
            int subResult = Emps.Max(e => e.Salary);
            IEnumerable<Emp> result = Emps.Where(e => e.Salary == subResult);
            return result;
        }
        ...
        {
            Emp result = Emps.FirstOrDefault(e => e.Job == "Frontend programmer");
            return result;
        }
        ...
        public static IEnumerable<object> Task10()
        {
            ...
            {
                new { Ename = "Brak wartości", Job = (string)null, Hiredate = (string)null }
            };
            IEnumerable<object> result = Emps.Select(e => new
            {
                e.Ename,
